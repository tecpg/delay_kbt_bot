...
def get_today_under_4_5_prediction(bs, set_date):

    url ="https://venasbet.com/under_3_5_goals?dt="
...
def get_previous_under_4_5_prediction(nbs,set_previous_date):
...
get_today_under_4_5_prediction(soup,p_date)
#time.sleep(6) 
#print("==============Bot is taking a nap... whopps!==================== ", time.ctime())  
get_previous_under_4_5_prediction(soup,x_date)
