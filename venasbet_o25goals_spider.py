...
def get_today_over_1_5_prediction(bs, set_date):
    ...
    url ="https://www.r2bet.com/gg_btts?dt="
    ...
    tabless = dom.xpath('//*[@id="home"]/table')
    print(tabless[0])
...
def connect_server():
    ...
    source_name = 'venasbet_o_2_5'
    more_tips_link = 'over-2-5-betting-tips'
