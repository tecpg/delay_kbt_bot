...
#print(x_date)
bs = soup
url ="https://www.winonbetonline.com/"
...
def get_today_prediction(bs, set_date):
    ...
    with open(csv_f, "w", encoding="utf8", newline="") as f:
        ...
        for x in range(1,tr_count -1):

            c = 1 + x
            i = str(c)
            
            league = dom.xpath(f'//*[@id="content"]/div/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div/div/table/tbody/tr[{i}]/td[1]/span')
            league = league[0].text
            match = dom.xpath(f'//*[@id="content"]/div/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div/div/table/tbody/tr[{i}]/td[2]/span')
            match = match[0].text
            picks = dom.xpath(f'//*[@id="content"]/div/div/div[1]/div[2]/div[2]/div/div/div/div[1]/div/div/table/tbody/tr[{i}]/td[3]/span')
            picks = picks[0].text
            timez = ""
            ...
            results = "N/A"
            odds="N/A"
            source = "winonbet_safe"
            flag = dom.xpath(f'//*[@id="content"]/div/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div/h3/span')
            flag = flag[0].text
            ...
            prediction = [league,remove(match),  picks, odds, timez, score, match_date, flag, results, match_code, source ]
...
def get_previous_prediction(bs, set_previous_date):
    ...
    with open(csv_f, "w", encoding="utf8", newline="") as f:
        ...
        for x in range(1,tr_count - 1):
            ...
            league = dom.xpath(f'//*[@id="content"]/div/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div/div/table/tbody/tr[{i}]/td[1]/span')
            league = league[0].text
            match = dom.xpath(f'//*[@id="content"]/div/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div/div/table/tbody/tr[{i}]/td[2]/span')
            match = match[0].text
            picks = dom.xpath(f'//*[@id="content"]/div/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div/div/table/tbody/tr[{i}]/td[3]/span')
            picks = picks[0].text
            timez = ""


            results = dom.xpath(f'//*[@id="content"]/div/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div/div/table/tbody/tr[{i}]/td[4]/img/@src')
            res = results[0]
            if res.find('green_tick') != -1:
             results = "Won"
            else:
             results = "Lost"
            odds="N/A"
