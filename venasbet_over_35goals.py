...
def get_today_over_3_5_prediction(bs, set_date):
    ...
    with open(csv_f, "w", encoding="utf8", newline="") as f:
        ...
        for x in range(0,tr_count - 1):
            ...
            results = "N/A"
            odds = kbt_funtions.get_random_odd_3()
            source = "venasbet_o_3_5"
            flag = ""
            match_date = set_date
...
def get_previous_over_3_5_prediction(nbs,set_previous_date):
    ...
    with open(csv_f, "w", encoding="utf8", newline="") as f:
        ...
        for x in range(0,tr_count - 1):
            ...
            odds=  odds = kbt_funtions.get_random_odd_3()
            source = "venasbet_o_3_5"
            flag = ""
...
def run():
    ...
    get_today_over_3_5_prediction(soup,p_date)
    #time.sleep(6) 
    #print("==============Bot is taking a nap... whopps!==================== ", time.ctime())  
    get_previous_over_3_5_prediction(soup,x_date)
